...
/turf/open/floor/plating/asteroid/airless/cave/volcanic
	...
	mob_spawn_list = list(/mob/living/simple_animal/hostile/asteroid/goliath/beast/random = 50, /obj/structure/spawner/lavaland/goliath = 4, \
        ...
        /mob/living/simple_animal/hostile/asteroid/crazy_miner/random = 10)*/ //Original
	...
	mob_spawn_list = list(/mob/living/simple_animal/hostile/asteroid/goliath/beast/random = 50, /obj/structure/spawner/lavaland/goliath = 6, \
		/mob/living/simple_animal/hostile/asteroid/basilisk/watcher/random = 20, /obj/structure/spawner/lavaland = 4, \
		/mob/living/simple_animal/hostile/asteroid/hivelord/legion/random = 40, /obj/structure/spawner/lavaland/legion = 6, \
		SPAWN_MEGAFAUNA = 6, /mob/living/simple_animal/hostile/asteroid/goldgrub = 10, \
        /mob/living/simple_animal/hostile/asteroid/crazy_miner/random = 10, \
        /mob/living/simple_animal/hostile/asteroid/fire_wisp = 10, \
        /mob/living/simple_animal/hostile/asteroid/ash_whelp = 15, \
        /mob/living/simple_animal/hostile/asteroid/abyss_demon = 15
        )
...
/turf/open/floor/plating/asteroid/airless/cave/Initialize()
	...
	if (!megafauna_abyss_spawn_list)
		megafauna_abyss_spawn_list = list(/mob/living/simple_animal/hostile/megafauna/dragon/hard = 4, /mob/living/simple_animal/hostile/megafauna/colossus/hard = 2, /mob/living/simple_animal/hostile/megafauna/bubblegum/hard = SPAWN_BUBBLEGUM)
	if (!flora_spawn_list)
